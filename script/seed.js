...
async function seed() {
  ...
  const events = await Promise.all([
    ...
    TripEvent.create({ purpose: 'Night activity', description: 'Villa Doria Pamphilj', placeName: 'Villa Doria Pamphilj',
                  ...
                  startDate: '2021-12-20', endDate: '2021-12-20', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'Night activity', description: 'Giardino degli Aranci', placeName: 'Giardino degli Aranci',
                  ...
                  startDate: '2021-12-20', endDate: '2021-12-20', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'Morning activity', description: 'Piazza di Spagna', placeName: 'Piazza di Spagna',
                  location: '',
                  ...
                  startDate: '2021-12-20', endDate: '2021-12-20', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'Morning activity', description: 'Piazza del Campidoglio', placeName: 'Piazza del Campidoglio',
    ...
    TripEvent.create({ purpose: 'Breakfast', description: 'Unique al Palatino', placeName: 'Unique al Palatino',
                  ...
                  startDate: '2021-12-21', endDate: '2021-12-21', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'Afternoon activity', description: 'Piazza di Spagna', placeName: 'Piazza di Spagna',
                  location: 'Via dei Cerchi 5500186 RomeItaly',
                  url: 'https://www.yelp.com/biz/piazza-di-spagna-roma?adjust_creative=rBDW7UJLMOHvUmVZrxCdEA&utm_campaign=yelp_api_v3&utm_medium=api_v3_business_search&utm_source=rBDW7UJLMOHvUmVZrxCdEA',  
                  startDate: '2021-12-21', endDate: '2021-12-21', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    ...
    TripEvent.create({ purpose: 'Night activity', description: 'Parco Villa Borghese', placeName: 'Parco Villa Borghese',
                  ...
                  startDate: '2021-12-22', endDate: '2021-12-22', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'Night activity', description: 'Club', placeName: 'iQ Hotel Roma', description: 'iQ Hotel Roma',
                  url: 'https://www.yelp.com/biz/iq-hotel-roma-roma?adjust_creative=rBDW7UJLMOHvUmVZrxCdEA&utm_campaign=yelp_api_v3&utm_medium=api_v3_business_search&utm_source=rBDW7UJLMOHvUmVZrxCdEA',
                  startDate: '2021-12-22', endDate: '2021-12-22', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'Morning activity', description: 'Parco Villa Borghese', placeName: 'Parco Villa Borghese',
                  url: 'https://www.yelp.com/biz/parco-villa-borghese-roma?adjust_creative=rBDW7UJLMOHvUmVZrxCdEA&utm_campaign=yelp_api_v3&utm_medium=api_v3_business_search&utm_source=rBDW7UJLMOHvUmVZrxCdEA', 
                  startDate: '2021-12-22', endDate: '2021-12-22', 
                  status: 'PROPOSED', tripId: trips[2].id })
  ])
