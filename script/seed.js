...
async function seed() {
  ...
  const events = await Promise.all([
    TripEvent.create({ purpose: 'DINNER', description: 'Burger King', 
    ...
    TripEvent.create({ purpose: 'LUNCH', description: 'Olive Garden', 
                  startDate: '2021-10-24', endDate: '2021-10-24', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'BREAKFAST', description: 'McDonalds', 
                  startDate: '2021-10-24', endDate: '2021-10-24', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'AFTERNOONACTIVITY', description: 'Museum', 
                  startDate: '2021-12-20', endDate: '2021-10-20', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'NIGHTACTIVITY', description: 'Club', 
                  startDate: '2021-12-21', endDate: '2021-12-21', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'MORNINGACTIVITY', description: 'Park', 
                  startDate: '2021-12-22', endDate: '2021-12-22', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'SLEEP', description: 'Hotel Rome', 
                  startDate: '2021-12-20', endDate: '2021-12-25', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'DINNER', description: "Wendy's", 
                  startDate: '2021-12-22', endDate: '2021-12-22', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'AFTERNOONACTIVITY', description: 'Canal', 
                  startDate: '2021-12-23', endDate: '2021-12-23', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'AFTERNOONACTIVITY', description: 'Sky Diving', 
                  startDate: '2021-12-23', endDate: '2021-12-23', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'DINNER', description: 'Long Horn', 
                  startDate: '2021-12-24', endDate: '2021-12-24', 
                  status: 'PROPOSED', tripId: trips[2].id }),
    TripEvent.create({ purpose: 'MORNINGACTIVITY', description: 'Garden', 
                  startDate: '2021-12-24', endDate: '2021-12-24', 
                  status: 'PROPOSED', tripId: trips[2].id }),
